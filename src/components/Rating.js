...
const Rating = ({ average }) => {
  ...
  if (Number.isInteger(average) && average) { // number
    starLoop = [...Array(average)].map((element, i) =>
      (<span className="star" key={randomId()} >
        <svg style={styleStar} title={i} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 267.5 511.93"><defs /><path className="cls-1" d="M267.5,0a31.63,31.63,0,0,0-28.7,17.8L173.5,150.2,27.4,171.4C1.2,175.2-9.3,207.5,9.7,226L115.4,329l-25,145.5c-4.5,26.1,23,46,46.4,33.7l130.7-68.6Z" /></svg>
        <svg style={styleStar} title={i} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 267.5 511.93"><defs /><g id="Layer_2" data-name="Layer 2"><g id="Layer_1-2" data-name="Layer 1"><path d="M0,439.6l130.7,68.6c23.4,12.3,50.9-7.6,46.4-33.7L152.1,329,257.8,226c19-18.5,8.5-50.8-17.7-54.6L94,150.2,28.7,17.8A31.63,31.63,0,0,0,0,0Z" /></g></g></svg>
      </span>))
  ...
  starLoop = [...Array(Math.floor(5)).fill(1)].map((element, i) =>
    (<span className="star" key={randomId()} >
      <svg style={styleStarGray} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 267.5 511.93"><defs /><path className="cls-1" d="M267.5,0a31.63,31.63,0,0,0-28.7,17.8L173.5,150.2,27.4,171.4C1.2,175.2-9.3,207.5,9.7,226L115.4,329l-25,145.5c-4.5,26.1,23,46,46.4,33.7l130.7-68.6Z" /></svg>
      <svg style={styleStarGray} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 267.5 511.93"><defs /><g id="Layer_2" data-name="Layer 2"><g id="Layer_1-2" data-name="Layer 1"><path d="M0,439.6l130.7,68.6c23.4,12.3,50.9-7.6,46.4-33.7L152.1,329,257.8,226c19-18.5,8.5-50.8-17.7-54.6L94,150.2,28.7,17.8A31.63,31.63,0,0,0,0,0Z" /></g></g></svg>
     </span>))
